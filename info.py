...
# Others
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/Cinema_Collection_Officiall') # Tutorial video link for opening shortlink website 
IS_TUTORIAL = bool(environ.get('IS_TUTORIAL', False))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'me_shamil')
P_TTI_SHOW_OFF = is_enabled((environ.get('P_TTI_SHOW_OFF', "False")), False)
IMDB = is_enabled((environ.get('IMDB', "True")), True)
SINGLE_BUTTON = is_enabled((environ.get('SINGLE_BUTTON', "True")), True)
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "⚡<b>File uploaded by [UNIVERSAL MOVIES](https://t.me/Cinema_Collection_Officiall)</b>⚡\n\n📂<b>File Name:</b> ⪧ {file_caption} \n <b>Size: </b>{file_size}\n\n❤")
...
ADMIN_USRNM = environ.get('ADMIN_USRNM','me_shamil') # WITHOUT @
MAIN_CHANNEL_USRNM = environ.get('MAIN_CHANNEL_USRNM','me_shamil') # WITHOUT @
DEV_CHANNEL_USRNM = environ.get('DEV_CHANNEL_USRNM','me_shamil') # WITHOUT @
LAZY_YT_HANDLE = environ.get('LAZY_YT_HANDLE','me_shamil')  # WITHOUT @ [  add only handle - don't add full url  ] 
MOVIE_GROUP_USERNAME = environ.get('MOVIE_GROUP_USERNAME', "Cinema_Collection_Officiall") #[ without @ ]
...
DISCUSSION_CHAT_USRNM = "me_shamil" #without @

# Download Tutorial Button #
DOWNLOAD_TEXT_NAME = "📥 HOW TO DOWNLOAD 📥"
DOWNLOAD_TEXT_URL = "https://t.me/Cinema_Collection_Officiall"

# Custom Caption Under Button #
CAPTION_BUTTON = "Get Updates"
CAPTION_BUTTON_URL = "https://t.me/Cinema_Collection_Officiall"
